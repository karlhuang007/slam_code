...
class Distribution:
    ...
    def __init__(self, offset = 0, values = [1.0]):
        self.offset = offset
        self.values = values[:]
        """this is a class constructor, which self represent an Object and values hier
        is a list, use [] to create and [:] to select all the elements in this list
        under have a value(index), which return a singel value of the index
        whenever looking at a class, the first function should be taken very care"""
